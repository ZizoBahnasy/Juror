#!/usr/bin/env python3
"""
Analyze cluster breadth and token usage, then save a report.
"""
...
def count_cluster_breadth(df):
    ...
    line0 = f"Cluster 0 max breadth: {breadth0} (top-level titles), tokens if listed: {tokens0}"
    ...
    line1 = f"Cluster 1 max breadth: {max1} under cluster_0 '{parent1}', tokens if listed: {tokens1}"
    ...
    lvl7 = df.dropna(subset=['cluster_7_name']).groupby(
        ['cluster_0_name','cluster_1_name','cluster_2_name','cluster_3_name',
         'cluster_4_name','cluster_5_name','cluster_6_name']
